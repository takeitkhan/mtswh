...
class CreatePpiBundleProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ppi_bundle_products', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('bundle_price')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('ppi_bundle_products');
    }
}
